...
namespace ModulB
{
    ...
    {
        private const string MODULE_NAME = "MODULE_B";

        private const string NAVIGATION_ITEM_NAME = "Modul B";
        ...
        private Type moduleViewType = typeof(Views.ModulBView);
        private Type menuViewType = typeof(Views.ModulBMenuView);
